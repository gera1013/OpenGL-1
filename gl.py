...
class Renderer(object):
    def __init__(self, screen):
        ...
        # posición de cámara y cubo
        self.cube_pos = glm.vec3(0, 0, 0)
    ...
    def rotate_cam(self, x, y, z):
        self.cam_angles = glm.vec3(y, x, z)
    ...
    def render(self):
        ...
        cam_translate = glm.translate(i, self.cam_pos)
        cam_pitch = glm.rotate(i, glm.radians(self.cam_angles[0]), glm.vec3(1, 0, 0))
        cam_yaw = glm.rotate(i, glm.radians(self.cam_angles[1]), glm.vec3(0, 1, 0))
        cam_roll = glm.rotate(i, glm.radians(0), glm.vec3(0, 0, 1))
